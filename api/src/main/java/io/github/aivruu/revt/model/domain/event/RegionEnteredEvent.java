...
/**
 * Called when a user entered a region.
 *
 * @since 2.0.0
 */
public final class RegionEnteredEvent extends RegionEvent {
  private static final HandlerList HANDLER_LIST = new HandlerList();

  public RegionEnteredEvent(final @NotNull RegionUserAggregateRoot region, final @NotNull String regionName, final @NotNull MovementType movement) {
